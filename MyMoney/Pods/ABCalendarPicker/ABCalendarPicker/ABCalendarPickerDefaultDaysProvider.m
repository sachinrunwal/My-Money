...
//     return ABCalendarPickerAnimationScrollUpOrDownBase - [provider animationForZoomOutToProvider:self];
}
...
- (NSString*)titleText
{
   ...
   // return [self.dateFormatterTitle stringFromDate:[self.dateOwner selectedDate]];
